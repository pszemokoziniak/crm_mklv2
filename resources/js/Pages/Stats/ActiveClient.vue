<template>
  <div>
    <h1 class="text-xl font-bold text-center text-indigo-700 py-3 mt-8 border-b border-indigo-100">Aktywni klienci</h1>
...
export default {
  ...
  data() {
    return {
      colors: COLORS,
      chartLabels: ['Aktywni', 'Nie aktywni'],
      data: {
        labels: ['Aktywni', 'Nie aktywni'],
        datasets: [{
          backgroundColor: COLORS,
          data: this.clientActive,
        }],
      },
      options: {
        responsive: true,
