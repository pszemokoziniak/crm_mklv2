<template>
  <div>
    <h1 class="text-xl font-bold text-center text-indigo-700 py-3 mt-8 border-b border-indigo-100">Oferty - wszystkie statusy</h1>
...
export default {
  ...
  data() {
    return {
      colors: COLORS,
      chartLabels: this.ofertaStatusWin[0] || [],
      data: {
        labels: this.ofertaStatusWin[0],
        datasets: [{
          backgroundColor: COLORS,
          data: this.ofertaStatusWin[1],
        }],
      },
      options: {
        responsive: true,
