<template>
  <div>
    <Head title="Contacts" />
    <h1 class="mb-8 text-3xl font-bold">Branża</h1>
    ...
    <div class="bg-white rounded-md shadow overflow-x-auto">
      <table class="w-full whitespace-nowrap">
        ...
        <tr v-for="item in branzas" :key="item.id" class="hover:bg-gray-100 focus-within:bg-gray-100">
          <td class="border-t">
            <Link class="flex items-center px-6 py-4 focus:text-indigo-500" :href="`/branza/${item.id}/edit`">
              {{ item.name }}
          ...
          <td class="w-px border-t">
            <Link class="flex items-center px-4" :href="`/branza/${item.id}/edit`" tabindex="-1">
