  ...
  <div>
    ...
    <div class="flex items-center justify-between mb-6">
      ...
      <Link class="btn-indigo" href="/clients/create">
        <span>Create</span>
        <span class="hidden md:inline">&nbsp;Klienci</span>
      </Link>
    </div>
    <div class="bg-white rounded-md shadow overflow-x-auto">
      <table class="w-full whitespace-nowrap">
        ...
        <tr v-for="item in clients.data" :key="contact.id" class="hover:bg-gray-100 focus-within:bg-gray-100">
          <td class="border-t">
            <Link class="flex items-center px-6 py-4 focus:text-indigo-500" :href="`/clients/${contact.id}/edit`">
              {{ item.name }}
