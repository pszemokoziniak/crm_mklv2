    ...
    <div class="max-w-3xl bg-white rounded-md shadow overflow-hidden">
      <form @submit.prevent="update">
        <div class="flex flex-wrap -mb-8 -mr-6 p-8">
          ...
          <text-area v-model="form.description" :error="form.errors.description" class="pb-8 pr-6 w-full lg:w-1/1" label="Opis" />        </div>
...
export default {
  ...
  methods: {
    ...
    // restore() {
    //   if (confirm('Are you sure you want to restore this kontaktPerson?')) {
    //     this.$inertia.put(`/kontaktperson/${this.kontaktPerson.id}/restore`)
    //   }
    // },
  },
}
