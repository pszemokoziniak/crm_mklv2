<template>
  <div>
    ...
    <trashed-message v-if="linkedin.deleted_at" class="mb-6" @restore="restore"> This faza has been deleted. </trashed-message>
...
export default {
  ...
  methods: {
    update() {
      this.form.post(`/linkedin/${this.linkedin.id}`)
    },
    destroy() {
